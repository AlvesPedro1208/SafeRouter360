...
//            System.err.println("⚠️ Erro ao criar tabela: " + e.getMessage());
//        }
//    }
    ...
    public static void listarAbrigos() {
        ...
        String sql = """
                SELECT id_abrigo,
                       ...
                       capacidade,
                       ocupacao_atual,
                       (capacidade - ocupacao_atual) AS vagas   
                FROM abrigos
                ORDER BY id_abrigo
                """;
    ...
    public static boolean excluirAbrigo(int id) {
        ...
        try (Connection conn = ConexaoOracle.conectar();
            ...
            System.err.println("Erro ao excluir abrigo: " + e.getMessage());
            return false;
        }
    }
    public static void excluirAbrigoViaTerminal() {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Digite o ID do abrigo que deseja excluir: ");
        int id = scanner.nextInt();
        boolean sucesso = excluirAbrigo(id);
        if (sucesso) {
